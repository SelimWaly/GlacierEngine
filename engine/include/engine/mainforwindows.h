...
#define USER_MSG_BEGIN 10000
#define USER_MSG_END 90000

#include "KScreen.h"
class API CGLACIERInstance
{
public:
	CGLACIERInstance();
	~CGLACIERInstance();
	void GLACIERWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
	void create(KGLACIERInitPara&);
	void release();
	KScreen* getScreen();
