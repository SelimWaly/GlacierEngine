...
KEditView::KEditView()
{
   ...
   // 
    ...
    /// @brief backspace add by weix at 2015-12-01
...
void KEditView::onDownDirect(kn_int iScreenX, kn_int iScreenY, KMessageMouse* pMsg)
{
	...
	SetAllSelect(false);
	int iWinX = iScreenX - m_rect.left();  // 
	int iWinY = iScreenY - m_rect.top();  // 
...
void KEditView::onKeydown(KMessageKey* pMsg)
{
	...
	//if(pMsg->m_msg_type == KMSG_TYPE_INPUT_ING) //
	//{

	//}
	//else if(pMsg->m_msg_type == KMSG_TYPE_INPUT_END)  //
	//{
	//	KMessageInput* pMsgInput = (KMessageInput*)pMsg;
	//	InsertChar(m_Index,pMsgInput->m_InputStr);
	//}
	//else if(pMsg->m_msg_type == KMSG_TYPE_CHAR) //
	//{
