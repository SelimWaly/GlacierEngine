...
public class MainActivity extends Activity
{
	...
	public static final String TAG = "glacier";
    ...
    static {   	   
        try {
            ...
            System.loadLibrary("glacierengine");
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	m_Handler = new Handler() {
    		public void handleMessage(Message msg) 
    		{
    			...
    			{
    			case JMSG_TIMER:
    				GlacierCore.sendGLACIERMessage(KMSG_TIMER, 0, 0);
    				break;
    			...
    			case JMSG_MOUSE_FILTER_TIMER:
    				...
    				{
    					GlacierCore.sendGLACIERMessage(KMSG_LBBUTTONUP, m_mouse_up_pos_x, m_mouse_up_pos_y);
    				}    				
    				break;
    			default:
    				break;
    ...
    {
    	int iRegister = GlacierCore.registerStaticCallback("com/glacier/MainActivity", "requestRenderFromGLACIER", "()V", GlacierCore.CB_FLIP);
    	Log.d(TAG, "MainActivity CB_FLIP = " + iRegister);
    	iRegister = GlacierCore.registerStaticCallback("com/glacier/MainActivity", "sendJavaMessage", "(IIILjava/lang/String;)I", GlacierCore.CB_SEND_JAVAMSG);
    ...
    {
    	int iRegister = 0;
    	for(int i = 0; i < GlacierCore.CB_SIZE; i++)
    	{
    		iRegister = GlacierCore.unregisterCallback(i);
    	} 	
    	return iRegister;
    }
    ...
    class MyOnGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onDoubleTapEvent(MotionEvent e) {
            ...
            GlacierCore.sendGLACIERMessage(KMSG_LBUTTONDBLCLK, (int)e.getX(), (int)e.getY());
            return false;
        }
	...
	OnTouchListener touchEvent = new OnTouchListener() {
		...
		public boolean onTouch(View v, MotionEvent event) 
		{
			...
			case MotionEvent.ACTION_DOWN:
				GlacierCore.sendGLACIERMessage(KMSG_LBBUTTONDOWN, iScreenX, iScreenY);
				if( m_b_mouse_filter )
				{				
			...
			case MotionEvent.ACTION_MOVE:
				...
				GlacierCore.sendGLACIERMessage(KMSG_MOUSEMOVE, iScreenX, iScreenY);
				m_mouse_pos_bak_x = iScreenX;
				m_mouse_pos_bak_y = iScreenY;
				if(iPointCount >= 2)
				{ 
					...
					GlacierCore.sendGLACIERMessageBuf(KMSG_TOUCH_MOVE, iPointCount, 0, buff.position(), buff.array());
			...
			case MotionEvent.ACTION_UP:
				...
				{
					GlacierCore.sendGLACIERMessage(KMSG_LBBUTTONUP, iScreenX, iScreenY);
				}
				break;
			case MotionEvent.ACTION_POINTER_DOWN:
				if(iPointCount >= 2)
				{
					...
					GlacierCore.sendGLACIERMessageBuf(KMSG_TOUCH_DOWN, iPointCount, 0, buff.position(), buff.array());	
				}
				break;
			case MotionEvent.ACTION_POINTER_UP:  
				{
					...
					GlacierCore.sendGLACIERMessageBuf(KMSG_TOUCH_UP, iPointCount, 0, buff.position(), buff.array());
				}
				break;
			}
	...
	// call by GLACIER thread
	public static void requestRenderFromGLACIER() {
		if (m_Handler != null) {			
    ...
    private class SkiaDrawView extends  View {
        ...
        protected void onSizeChanged(int w, int h, int oldw, int oldh)
        {
        	...
        	String savPath = Environment.getExternalStorageDirectory()+"/engine/sav/";
        	...
        	{
        		Toast.makeText(getApplicationContext(), "NO MAP DATA, please check /sdcard/glacier",
        	...
        	else
        	{
				...
				GlacierCore.initializeEngine(m_strDataPath, savPath, m_SkiaBitmap, w, h);
	        }
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            Rect dst = new Rect (0, 0, m_width, m_height);
         	...
         	//Log.d(TAG, String.format("m_iHMIEngineWidth w(%d)h(%d), m_width w(%d) h(%d)", m_iHMIEngineWidth, m_iHMIEngineHeight, m_width, m_height));
           	GlacierCore.drawIntoBitmap(m_SkiaBitmap, m_width, m_height, 0);
